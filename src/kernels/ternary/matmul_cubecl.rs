...
mod tests {
    ...
    fn test_ternary_matmul_kernel_correctness() {
        ...
        assert!(
            (output[0] - expected_0_0).abs() < 0.01,
            "Feature 0 mismatch: expected {}, got {}",
            expected_0_0,
            output[0]
        );
        assert!(
            (output[1] - expected_0_1).abs() < 0.01,
            "Feature 1 mismatch: expected {}, got {}",
            expected_0_1,
            output[1]
        );
        assert!(
            (output[2] - expected_0_2).abs() < 0.01,
            "Feature 2 mismatch: expected {}, got {}",
            expected_0_2,
            output[2]
        );
